...
0000000000001169 <main>:
    ...
    116e:	48 89 e5             	mov    rbp,rsp  # put the addr. of the top of stack in rbp
    1171:	48 83 ec 10          	sub    rsp,0x10  # rsp = rsp - 0x10; #  make room on the stack for 16 bytes
    1175:	89 7d fc             	mov    DWORD PTR [rbp-0x4],edi  # saves edi (argc) on the stack
    ...
    118e:	48 89 d6             	mov    rsi,rdx # rsi = &password string -- second arg.
    ...
    11ac:	eb 0f                	jmp    11bd <main+0x54> # don't fall through and also print access denied
    11ae:	48 8d 05 6a 0e 00 00 	lea    rax,[rip+0xe6a] # start of else # load string 2010      # 201f <_IO_stdin_used+0x1f>
