...
0000000000001169 <main>:
    ...
    119d:	48 8d 05 6c 0e 00 00 	lea    rax,[rip+0xe6c] # start of the if # load string 2010       # 2010 <_IO_stdin_used+0x10>
    11a4:	48 89 c7             	mov    rdi,rax # make it the first arg
    11a7:	e8 b4 fe ff ff       	call   1060 <puts@plt> # call printing func.
    11ac:	eb 0f                	jmp    11bd <main+0x54> # skip over the else
    ...
    11b8:	e8 a3 fe ff ff       	call   1060 <puts@plt> # calls printing func.
    11bd:	b8 00 00 00 00       	mov    eax,0x0 # end of if/else
    11c2:	c9                   	leave # clean up stack
    11c3:	c3                   	ret
